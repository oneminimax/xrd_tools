...
\begin{align*}
	...
	% &= \frac{1}{2k_j\sin\theta_j}\pmqty{
	% 	k_{j} e^{-ik_{z,j}z_j}\sin\theta_{j-1} e^{ik_{z,j-1}z_j} + 
	% 	\sin\theta_{j} e^{-ik_{z,j}z_j}k_{j-1} e^{ik_{z,j-1}z_j} &
	% 	-k_{j} e^{-ik_{z,j}z_j}\sin\theta_{j-1} e^{-ik_{z,j-1}z_j} + 
	% 	\sin\theta_{j} e^{-ik_{z,j}z_j}k_{j-1} e^{-ik_{z,j-1}z_j} \\
	% 	-k_{j} e^{ik_{z,j}z_j}\sin\theta_{j-1} e^{ik_{z,j-1}z_j} + 
	% 	\sin\theta_{j} e^{ik_{z,j}z_j}k_{j-1} e^{ik_{z,j-1}z_j} &
	...
	% }\\
	% &= \frac{1}{2k_j\sin\theta_j}\pmqty{
	% 	k_{j} \sin\theta_{j-1} e^{-ik_{z,j}^{-}z_j} + 
	% 	k_{j-1} \sin\theta_{j} e^{-ik_{z,j}^{-}z_j} &
	% 	-k_{j} \sin\theta_{j-1} e^{-ik_{z,j}^{+}z_j} + 
	% 	k_{j-1} \sin\theta_{j} e^{-ik_{z,j}^{+}z_j} \\
	% 	-k_{j} \sin\theta_{j-1} e^{ik_{z,j}^{+}z_j} + 
	% 	k_{j-1} \sin\theta_{j} e^{ik_{z,j}^{+}z_j} &
	...
	% 	\pqty{\frac{k_{j}}{k_{j-1}} k_{z,j-1}  + 
	% 	 		\frac{k_{j-1}}{k_{j}} k_{z,j} }e^{-ik_{z,j}^{-}z_j} &
	% 	\pqty{-\frac{k_{j}}{k_{j-1}} k_{z,j-1}  + 
	% 	 		\frac{k_{j-1}}{k_{j}} k_{z,j} } e^{-ik_{z,j}^{+}z_j}\\
	% 	\pqty{-\frac{k_{j}}{k_{j-1}} k_{z,j-1}  + 
	% 	 		\frac{k_{j-1}}{k_{j}} k_{z,j} }e^{ik_{z,j}^{+}z_j} &
	...
	% 	\pqty{ n_{j}^2 k_{z,j-1}  + 
	% 	 		n_{j-1}^2 k_{z,j} }e^{-ik_{z,j}^{-}z_j} &
	% 	\pqty{- n_{j}^2 k_{z,j-1}  + 
	% 	 		n_{j-1}^2 k_{z,j} } e^{-ik_{z,j}^{+}z_j}\\
	% 	\pqty{- n_{j}^2 k_{z,j-1}  + 
	% 	 		n_{j-1}^2 k_{z,j} }e^{ik_{z,j}^{+}z_j} &
...
\begin{align*}
	...
	% &= \frac{
	% n_{j-1}^4 k^2_{z,j} + n_{j}^4 k^2_{z,j-1} + 2n_{j-1}^2 k_{z,j} n_{j}^2 k_{z,j-1}
	% - n_{j-1}^4 k^2_{z,j} - n_{j}^4 k^2_{z,j-1} + 2n_{j-1}^2 k_{z,j} n_{j}^2 k_{z,j-1}
	% }{4n^2_{j-1}n^2_{j}k^2_{z,j}} \\
	% &= \frac{
	% 4n_{j-1}^2 k_{z,j} n_{j}^2 k_{z,j-1}
	% }{4n^2_{j-1}n^2_{j}k^2_{z,j}} \\
...
\begin{align*}
	...
	% &= \frac{1}{-2 k_j \sin\theta_{j} }
	% \pmqty{
	% 	- k_j \sin\theta_{j} e^{-ik_{z,j}^{-}z_j} 
	% 	- k_{j-1} \sin\theta_{j-1} e^{-ik_{z,j}^{-}z_j} &
	% 	- k_j \sin\theta_{j} e^{-ik_{z,j}^{+}z_j}k_{j-1} 
	% 	+ k_{j-1} \sin\theta_{j-1} e^{-ik_{z,j}^{+}z_j}  \\
	% 	- k_j \sin\theta_{j} e^{ik_{z,j}^{+}z_j}
	% 	+ k_{j-1} \sin\theta_{j-1} e^{ik_{z,j}^{+}z_j} & 
	% 	- k_j \sin\theta_{j} e^{ik_{z,j}^{-}z_j}k_{j-1} 
	...
	% 	- k_{z,j-1} e^{-ik_{z,j}^{-}z_j} &
	% 	- k_{z,j} e^{-ik_{z,j}^{+}z_j}k_{j-1} 
	% 	+ k_{z,j-1} e^{-ik_{z,j}^{+}z_j}  \\
	% 	- k_{z,j} e^{ik_{z,j}^{+}z_j}
	% 	+ k_{z,j-1} e^{ik_{z,j}^{+}z_j} & 
	% 	- k_{z,j} e^{ik_{z,j}^{-}z_j}k_{j-1} 
...
\begin{align*}
	...
	% &= \frac{k_{z,j}^2 + k_{z,j-1}^2 + 2k_{z,j} k_{z,j-1} - k_{z,j}^2 - k_{z,j-1}^2 + 2k_{z,j} k_{z,j-1}}{4 k_{z,j}^2} \\
	% &= \frac{4k_{z,j} k_{z,j-1}}{4 k_{z,j}^2} \\
	                            & = \frac{ k_{z,j-1}}{ k_{z,j}}
\end{align*}
...
% 	\pmqty{ 
% 		\pqty{
% 			\frac{k^2_{j-1} \sin\theta_{j-1}}{k^2_{j} \sin\theta_{j}}    
