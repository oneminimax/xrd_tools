...
from XRDTools.Spectrum import centroid, calculate_A, fitAGFct, AGFct, estimate_noise_level
...
for sample_tuple in sample_tuples:
    ...
    sub_ind = (two_theta > two_theta_lim[0]) * (two_theta < two_theta_lim[1]) * np.logical_not((two_theta > two_theta_sub[0]) * (two_theta < two_theta_sub[1])) 
