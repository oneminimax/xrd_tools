...
# dm = Diffractometer(cristal_structure = Si, surface_normal_hkl = hkl_z,azimuth_pqr = pqr_x)

# # Show some peaks values
# HKL = (0,0,2)
# print('hkl : {0:d}{1:d}{2:d}, 2T : {3:.4f}, Source : {4:.4f}, Detector : {5:.4f}, Phi : {6:.4f}, Factor : {7:.3f}'.format(*HKL,dm.hkl_2_two_theta(HKL),*dm.hkl_2_theta_source_theta_detector_phi(HKL),Si.structure_factor(HKL)))
