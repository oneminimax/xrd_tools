import numpy as np
from XRDTools.Math import fourier_transform
...
def calculate_ag(wave_vector,amplitude,amplitude_error,x_max = 130,x_step = 2):
    ...
    ag, abs_ag_error, arg_ag_error = fourier_transform(wave_vector,amplitude,x,window_fct = np.hanning, y_error = amplitude_error)
